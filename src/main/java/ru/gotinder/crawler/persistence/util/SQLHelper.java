...
public interface SQLHelper {
    ...
    String LOAD_BY_RATING = "SELECT * FROM crawler_data WHERE verdict = 0 AND (length(?) = 0 OR bio like '%'|| lower(?) || '%') AND verdict_sync_at is null ORDER BY rating desc, updated_at DESC LIMIT ? OFFSET ?";
